...
const NotificationCenter = () => {
  ...
  const getNotificationIcon = (type) => {
    switch (type) {
      case 'WORK_ASSIGNED':
        return (
          <div className="flex-shrink-0 rounded-full p-1 bg-primary/10 text-primary">
                ...
                notifications.map((notification) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`block px-4 py-3 hover:bg-gray-50 transition duration-150 ease-in-out ${isUnread ? 'bg-primary/5' : ''}`}
